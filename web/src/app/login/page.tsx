    ...
    <div className="min-h-screen flex flex-col lg:flex-row bg-[#F8FAFC] dark:bg-[#0B1121] text-gray-900 dark:text-gray-100 font-sans transition-colors duration-300">
      ...
      <div className="lg:w-1/2 flex flex-col justify-between p-8 lg:p-16 relative overflow-hidden hidden lg:flex bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-[#0f172a] dark:to-[#0B1121]">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2 mb-12">
            ...
            <span className="text-gray-900 dark:text-white font-bold text-xl tracking-tight">Secure Vault</span>
            <span className="text-xs uppercase tracking-widest text-gray-500 ml-2 mt-1 hidden xl:inline-block">Your Financial Fortress</span>
          </div>
        </div>

        {/* Abstract Data Image Mockup */}
        <div className="relative flex-1 flex items-center justify-center my-8 z-10 w-full max-w-md mx-auto">
          <div className="w-full aspect-[4/5] bg-black rounded-3xl overflow-hidden shadow-2xl relative border border-gray-800">
            ...
            <div className="absolute bottom-8 left-8 z-20">
                <div className="text-white font-mono text-xl tracking-widest">US$ 1.0</div>
            </div>
          </div>
        ...
        <div className="relative z-10 mt-8 max-w-md mx-auto">
          ...
          <p className="text-lg text-gray-800 dark:text-gray-200 font-medium leading-relaxed italic mb-6">
            "Nocturnal Finance provides the clarity and security our firm needs for complex overnight market analysis. It's the ultimate navigator for global capital."
          </p>
          <div className="flex items-center gap-4">
            ...
            <div>
              <div className="font-bold text-gray-900 dark:text-white">Marcus Thorne</div>
              <div className="text-sm text-gray-500 dark:text-gray-400">CFO, ATLAS VENTURES</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="lg:w-1/2 flex items-center justify-center p-8 bg-white dark:bg-[#0B1121] relative z-20">
        ...
        <div className="absolute top-8 left-8 flex items-center lg:hidden">
            <span className="text-blue-600 dark:text-blue-500 font-bold text-xl tracking-tight">Secure Vault</span>
        </div>

        <div className="absolute top-8 right-8 hidden lg:block text-sm">
            <span className="text-gray-500 dark:text-gray-400">Don't have an account? </span>
            <Link href="/register" className="text-blue-600 dark:text-blue-400 hover:text-blue-700 font-medium">Get Started</Link>
        </div>

        <div className="w-full max-w-sm mt-16 lg:mt-0">
          <div className="mb-10 text-center lg:text-left">
            <h2 className="text-3xl font-bold mb-2">Welcome Back</h2>
            <p className="text-gray-500 dark:text-gray-400 text-sm">Access your global financial dashboard securely.</p>
          </div>
          ...
          <div className="flex items-center mb-8">
            ...
            <span className="px-4 text-xs text-gray-400 dark:text-gray-500 font-medium uppercase tracking-wider">Or sign in with email</span>
            <div className="flex-1 border-t border-gray-200 dark:border-gray-800"></div>
          </div>
          ...
          <form className="space-y-6">
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                  <label className="block text-xs font-semibold text-gray-700 dark:text-gray-300 uppercase tracking-wide opacity-80">Password</label>
                  <Link href="#" className="text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 font-medium">Forgot Password?</Link>
              </div>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
            ...
            <button type="submit" className="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3.5 rounded-xl transition-colors shadow-lg shadow-blue-500/30">
              Sign In
            </button>
          </form>

          <p className="mt-12 text-center text-xs text-gray-500 dark:text-gray-500">
            © 2024 Nocturnal Finance. All rights reserved.<br/>
            <Link href="#" className="hover:text-blue-500">Privacy Policy</Link> • <Link href="#" className="hover:text-blue-500">Terms of Service</Link>
          </p>
        </div>
      </div>
    </div>
